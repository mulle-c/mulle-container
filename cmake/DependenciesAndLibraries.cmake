if( NOT __MULLE_CONTAINER_DEPENDENCIES_AND_LIBRARIES_CMAKE__)
   set( __MULLE_CONTAINER_DEPENDENCIES_AND_LIBRARIES_CMAKE__ ON)
   ...
   #
   #if( MSVC)
   #   set( MULLE_CONTAINER_DEFINITIONS $<|PARENT_IDENTIFIER|>_DEFINITIONS})
   #endif()
endif()
