if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "mulle-container-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_CONTAINER_DEFINITIONS})
...
mulle-container-standalone.c with contents like this to it:
   int  ___mulle_container_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} mulle-container)
         if( STARTUP_NAME)
