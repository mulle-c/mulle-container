...
if( NOT CITYHASH_LIBRARY)
   find_library( CITYHASH_LIBRARY NAMES ${CMAKE_STATIC_LIBRARY_PREFIX}cityhash${CMAKE_STATIC_LIBRARY_SUFFIX} cityhash)
   ...
   if( CITYHASH_LIBRARY)
      ...
      # temporarily expand CMAKE_MODULE_PATH
      get_filename_component( _TMP_CITYHASH_ROOT "${CITYHASH_LIBRARY}" DIRECTORY)
      get_filename_component( _TMP_CITYHASH_ROOT "${_TMP_CITYHASH_ROOT}" DIRECTORY)

      # search for DependenciesAndLibraries.cmake to include
      foreach( _TMP_CITYHASH_NAME in cityhash)
         set( _TMP_CITYHASH_DIR "${_TMP_CITYHASH_ROOT}/include/${_TMP_CITYHASH_NAME}/cmake")
         # use explicit path to avoid "surprises"
         if( EXISTS "${_TMP_CITYHASH_DIR}/DependenciesAndLibraries.cmake")
            unset( CITYHASH_DEFINITIONS)
            list( INSERT CMAKE_MODULE_PATH 0 "${_TMP_CITYHASH_DIR}")
            include( "${_TMP_CITYHASH_DIR}/DependenciesAndLibraries.cmake")
            list( REMOVE_ITEM CMAKE_MODULE_PATH "${_TMP_CITYHASH_DIR}")
            set( INHERITED_DEFINITIONS
               ${INHERITED_DEFINITIONS}
      ...
      message( FATAL_ERROR "CITYHASH_LIBRARY was not found")
   endif()
endif()
