...
Use `mulle_chained_hash` to incrementally calculate a hash. The initial `hash` value is called the seed. To the knowledge of the author, this can be initialized with 0 without problems.
